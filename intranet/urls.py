...
urlpatterns = [
    ...
    path('api/enviar/', views.enviar_formulario),
    path('api/postular/', views.postular),
    path('api/chart/',
         api.ChartView.as_view(), name='chart'),
    path('api/jquery-toast/', api.JqueryToastView.as_view(),
    ...
    path('api/consulta/', api.ConsultaListApiView.as_view(), name='consulta'),
